...
In both cases, the pdf outputs are written in /figs.

Experimental data with 5000 variants, taken from from https://github.com/omghosh/limiting-functions, is analyzed with 3_Exponenital_data.ipynb. The csv data file is in /data. The figures of the analysis are directed to /data/figs. 
